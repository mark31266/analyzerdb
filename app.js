...
const io = require("socket.io")(server, {
  ...
  app.get("/myth22/results", function(req,res)
  {
    const sessionCookie = req.cookies.session || "";
    admin
      .auth()
      .verifySessionCookie(sessionCookie, true)
      .then(() => {
        res.render("myth22/results.html");
  ...
  app.get("/myth18/results", function(req,res)
  {
    const sessionCookie = req.cookies.session || "";
    admin
      .auth()
      .verifySessionCookie(sessionCookie, true)
      .then(() => {
        res.render("myth18/results.html");
  ...
  app.get("/myth60/results", function(req,res)
  {
    const sessionCookie = req.cookies.session || "";
    admin
      .auth()
      .verifySessionCookie(sessionCookie, true)
      .then(() => {
        res.render("myth60/results.html");
  ...
  app.get("/myth22/settings", function(req,res)
  {
    const sessionCookie = req.cookies.session || "";
  ...
  app.get("/myth18/settings", function(req,res)
  {
    const sessionCookie = req.cookies.session || "";
    ...
    admin
      ...
      .verifySessionCookie(sessionCookie, true)
      .then(() => {
        res.render("myth18/settings.html");
      })
      .catch((error) => {
        res.redirect("/login");
      });
  });
  app.get("/myth60/settings", function(req,res)
  {
    const sessionCookie = req.cookies.session || "";
    ...
    admin
      ...
      .verifySessionCookie(sessionCookie, true)
      .then(() => {
        res.render("myth60/settings.html");
      })
      .catch((error) => {
        res.redirect("/login");
      });
  });
  app.get("/myth22/about", function(req,res)
  {
    const sessionCookie = req.cookies.session || "";
    admin
      .auth()
  ...
  app.get("/myth18/about", function(req,res)
  {
    const sessionCookie = req.cookies.session || "";
    admin
      .auth()
      .verifySessionCookie(sessionCookie, true)
      .then(() => {
        res.render("myth18/about.html");
      })
      .catch((error) => {
        res.redirect("/login");
      });
  });
  app.get("/myth60/about", function(req,res)
  {
    const sessionCookie = req.cookies.session || "";
    admin
      .auth()
      .verifySessionCookie(sessionCookie, true)
      .then(() => {
        res.render("myth60/about.html");
      })
      .catch((error) => {
        res.redirect("/login");
      });
  });
  app.get("/myth22/home", function(req,res)
  {
    const sessionCookie = req.cookies.session || "";
    admin
      .auth()
  ...
  app.get("/myth18/home", function(req,res)
  {
    const sessionCookie = req.cookies.session || "";
    admin
      .auth()
      .verifySessionCookie(sessionCookie, true)
      .then(() => {
        res.render("myth18/home.html");
      })
      .catch((error) => {
        res.redirect("/login");
      });
  });
  app.get("/myth60/home", function(req,res)
  {
    const sessionCookie = req.cookies.session || "";
    admin
      .auth()
